...
const Profile = () => {
  ...
  const handleSkillsChange = (e) => {
    const skillsArray = String(e.target.value)
      .split(",")
      .map((s) => s.trim())
      .filter(Boolean);
    ...
    try {
      ...
      if (imageFile) {
        ...
        if (imgRes?.data?.success) {
          finalProfile.profilePicture = imgRes.data.data.profilePicture;
        } else {
      ...
      const payload = {
        ...finalProfile,
        socialLinks: {
          linkedIn: normalizeUrl(finalProfile?.socialLinks?.linkedIn),
          github: normalizeUrl(finalProfile?.socialLinks?.github),
          portfolio: normalizeUrl(finalProfile?.socialLinks?.portfolio),
        },
      };
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-lg shadow-sm">
          ...
          <div className="divide-y divide-gray-200">
            ...
            <div className="p-6 grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="md:col-span-1">
                ...
                <p className="mt-1 text-sm text-gray-500">
                  Tell us about your college and skills.
                </p>
              </div>
              <div className="md:col-span-2 space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="mt-1 block w-full rounded-md border-0 bg-white py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600"
            ...
            <div className="p-6 grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="md:col-span-1">
                ...
                <p className="mt-1 text-sm text-gray-500">
                  Your professional links and a short bio.
                </p>
              </div>
              <div className="md:col-span-2 space-y-4">
                <div>
                ...
                <div>
                  ...
                  <div className="relative mt-1">
                    ...
                    <input
                      ...
                      className="block w-full rounded-md border-0 bg-white py-1.5 pl-10 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600"
          ...
          <div className="flex items-center justify-end gap-x-6 p-6">
            <button
              type="submit"
              disabled={isSaving}
              className="px-5 py-2.5 bg-indigo-600 text-white font-semibold rounded-lg shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 disabled:bg-indigo-400 disabled:cursor-not-allowed"
            >
